...
import 'package:test_app/services/chat_service.dart';
import 'package:test_app/services/socket_service.dart';
import 'package:test_app/services/usuarios_services.dart';
...
class _UsuariosPageState extends State<UsuariosPage> {
  ...
  final usuarioServices = UsuariosServices();
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          Container(
            ...
            child: (socketService.serverStatus == ServerStatus.Online) ? Icon( Icons.check_circle, color: Colors.green[400] ) : 
